...
namespace Core.Repositories
{
    public interface IConsumoGasoilRepositorio
    {
        ...
        Task<(int IdPrograma, decimal Kilometros, string Destino)?> ObtenerProgramaPorPatenteAsync(string patenteTractor, DateTime FechaCreacion);
        ...
        Task<List<ConsumoGasoilAutorizadoDto>> ObtenerConsumosUltimosDosMesesDesdeFechaAsync(
            string patente,
